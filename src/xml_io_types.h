...
TMPL_XML_READ_WRITE_STREAM(SpectralSingleScatteringData)
...
TMPL_XML_READ_WRITE_STREAM(ArrayOfArrayOfSpectralSingleScatteringData)
...
TMPL_XML_READ_WRITE_STREAM(ArrayOfSpectralSingleScatteringData)
