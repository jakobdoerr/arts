...
TMPL_XML_READ_WRITE(QuantumNumberRecord)
...
TMPL_XML_READ_WRITE(SpectralSingleScatteringData)
...
TMPL_XML_READ_WRITE(ArrayOfArrayOfSpectralSingleScatteringData)
...
TMPL_XML_READ_WRITE(ArrayOfSpectralSingleScatteringData)
