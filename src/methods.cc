    ...
    ( MdRecord
      ( NAME( "iyMC" ),
        ...
        IN( "iy_agenda_call1", "iy_transmission", "rte_pos", "rte_los", 
            ...
            "stokes_dim", "f_grid", "scat_data", 
            "iy_space_agenda", "surface_rtprop_agenda",
            "propmat_clearsky_agenda", "ppath_step_agenda", "ppath_lmax",
    ...
    ( MdRecord
      ( NAME( "MCRadar" ),
        ...
        IN( "mc_antenna", "f_grid", "f_index", "sensor_pos", "sensor_los", 
            ...
            "lat_grid", "lon_grid", "z_field", "refellipsoid", "z_surface", 
            "t_field", "vmr_field", "cloudbox_on", "cloudbox_limits", 
            "pnd_field", "scat_data", "mc_y_tx", "range_bins",
            "atmfields_checked", "atmgeom_checked", "scat_data_checked",
    ...
    ( MdRecord
      ( NAME( "x2artsAtmAndSurf" ),
        ...
        IN( "vmr_field", "t_field", "particle_bulkprop_field",
            "wind_u_field", "wind_v_field", "wind_w_field",
            "mag_u_field", "mag_v_field", "mag_w_field", "surface_props_data",
